 ...
 * Init 2017-12-18
 * Configured for BMS Thermistor ECU rev1
...
void setup() {
    ...
    pinMode(SEG0_C4, INPUT);
    pinMode(SEG0_C5, INPUT);
    pinMode(SEG1_C0, INPUT);
    pinMode(SEG1_C1, INPUT);
    pinMode(SEG1_C2, INPUT);
    pinMode(SEG1_C3, INPUT);
    pinMode(SEG1_C4, INPUT);
    pinMode(SEG1_C5, INPUT);
...
void read_temperatures() {
    ...
    raw_temperatures[5] = analogRead(SEG0_C5);
    raw_temperatures[6] = analogRead(SEG1_C0);
    raw_temperatures[7] = analogRead(SEG1_C1);
    raw_temperatures[8] = analogRead(SEG1_C2);
    raw_temperatures[9] = analogRead(SEG1_C3);
    raw_temperatures[10] = analogRead(SEG1_C4);
    raw_temperatures[11] = analogRead(SEG1_C5);
