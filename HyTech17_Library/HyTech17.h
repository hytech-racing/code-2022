...
#define DCU_STATE_WAITING_NO_TS 1
#define DCU_STATE_PRESSED_TRACTIVE_SYSTEM 2
#define DCU_STATE_WAITING_TRACTIVE_SYSTEM 3
#define DCU_STATE_PRESSED_MC_ENABLE 4
#define DCU_STATE_PLAYING_RTD 5
#define DCU_STATE_READY_TO_DRIVE 6
