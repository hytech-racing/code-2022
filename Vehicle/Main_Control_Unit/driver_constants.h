...
#include "drivers.h"
...
#ifdef DRIVER
    #if DRIVER == DAVID
        #define BRAKE_ACTIVE 50000               // Threshold for brake pedal active  

        #define MIN_ACCELERATOR_PEDAL_1 1250    // Low accelerator implausibility threshold
        ...
        #define MAX_ACCELERATOR_PEDAL_1 1950    // High accelerator implausibility threshold
        ...
        #define MAX_ACCELERATOR_PEDAL_2 990    // High accelerator implausibility threshold
    #else
