...
static void loadLookupTable() {
  CAN_MSG_DEFINITION[0xA0] = pair<string, vector<definition>> ("ID_MC_TEMPERATURES_1", {
    definition(0, 2, true, "MODULE A TEMP", "C", 0.1),
    definition(2, 2, true, "MODULE B TEMP", "C", 0.1),
    definition(4, 2, true, "MODULE C TEMP", "C", 0.1),
    definition(6, 2, true, "GATE DRIVER BOARD TEMP", "C", 0.1)
  });
  CAN_MSG_DEFINITION[0xA1] = pair<string, vector<definition>> ("ID_MC_TEMPERATURES_2", {
    definition(0, 2, true, "CONTROL BOARD TEMPERATURE", "C", 0.1),
    definition(2, 2, true, "RTD 1 TEMPERATURE", "C", 0.1),
    definition(4, 2, true, "RTD 2 TEMPERATURE", "C", 0.1),
    definition(6, 2, true, "RTD 3 TEMPERATURE", "C", 0.1)
  });
  CAN_MSG_DEFINITION[0xA2] = pair<string, vector<definition>> ("ID_MC_TEMPERATURES_3", {
    definition(0, 2, true, "RTD 4 TEMP", "C", 0.1),
    definition(2, 2, true, "RTD 5 TEMP", "C", 0.1),
    definition(4, 2, true, "MOTOR TEMP", "C", 0.1),
    definition(6, 2, true, "TORQUE SHUDDER", "C", 0.1)
  });
  ...
  CAN_MSG_DEFINITION[0xA5] = pair<string, vector<definition>> ("ID_MC_MOTOR_POSITION_INFORMATION", {
    definition(0, 2, true, "MOTOR ANGLE", "", 0.1),
    definition(2, 2, true, "MOTOR SPEED", "RPM"),
    definition(4, 2, true, "ELEC OUTPUT FREQ", "", 0.1),
    definition(6, 2, true, "DELTA RESOLVER FILT")
  });
  CAN_MSG_DEFINITION[0xA6] = pair<string, vector<definition>> ("ID_MC_CURRENT_INFORMATION", {
    definition(0, 2, true, "PHASE A CURRENT", "A", 0.1),
    definition(2, 2, true, "PHASE B CURRENT", "A", 0.1),
    definition(4, 2, true, "PHASE C CURRENT", "A", 0.1),
    definition(6, 2, true, "DC BUS CURRENT", "A", 0.1)
  });
  CAN_MSG_DEFINITION[0xA7] = pair<string, vector<definition>> ("ID_MC_VOLTAGE_INFORMATION", {
    definition(0, 2, true, "DC BUS VOLTAGE", "V", 0.1),
    definition(2, 2, true, "OUTPUT VOLTAGE", "V", 0.1),
    definition(4, 2, true, "PHASE AB VOLTAGE", "V", 0.1),
    definition(6, 2, true, "PHASE BC VOLTAGE", "V", 0.1)
  });
  ...
  CAN_MSG_DEFINITION[0xAC] = pair<string, vector<definition>> ("ID_MC_TORQUE_TIMER_INFORMATION", {
    definition(0, 2, true, "COMMANDED TORQUE", "Nm", 0.1),
    definition(2, 2, true, "TORQUE FEEDBACK", "Nm", 0.1),
    definition(4, 4, false, "RMS UPTIME", "s", 0.003)
  });
  ...
  CAN_MSG_DEFINITION[0xC0] = pair<string, vector<definition>> ("ID_MC_COMMAND_MESSAGE", {
    definition(0, 2, true, "TORQUE COMMAND", "", 0.1),
  ...
  CAN_MSG_DEFINITION[0xC3] = pair<string, vector<definition>> ("ID_MCU_STATUS", {
    ...
    definition(1, 1, {"BMS OK HIGH", "IMD OK HIGH", "INVERTER POWERED", "SHUTDOWN B ABOVE THRESHOLD", "SHUTDOWN C ABOVE THRESHOLD", "SHUTDOWN D ABOVE THRESHOLD", "SHUTDOWN E ABOVE THRESHOLD", "SHUTDOWN F ABOVE THRESHOLD"}),
    definition(2, 2, true, "TEMPERATURE", "C", 0.01),
    definition(4, 2, false, "GLV BATTERY VOLTAGE", "V", 0.01)
  });
  ...
  CAN_MSG_DEFINITION[0xCC] = pair<string, vector<definition>> ("ID_GLV_CURRENT_READINGS", {
    definition(0, 2, false, "ECU CURRENT", "A", 0.01),
    definition(2, 2, false, "COOLING CURRENT", "A", 0.01)
  });
  ...
  CAN_MSG_DEFINITION[0xD7] = pair<string, vector<definition>> ("ID_BMS_VOLTAGES", {
    ...
    definition(2, 2, false, "BMS VOLTAGE LOW", "V", 0.001),
    definition(4, 2, false, "BMS VOLTAGE HIGH", "V", 0.001),
    definition(6, 2, false, "BMS VOLTAGE TOTAL", "V", 0.001)
  });
  CAN_MSG_DEFINITION[0xD8] = pair<string, vector<definition>> ("ID_BMS_DETAILED_VOLTAGES", {
    definition(0, 1, false, "IC ID GROUP ID"),
    definition(1, 2, false, "VOLTAGE 0", "V", 0.001),
    definition(3, 2, false, "VOLTAGE 1", "V", 0.001),
    definition(5, 2, false, "VOLTAGE 2", "V", 0.001)
  });
  CAN_MSG_DEFINITION[0xD9] = pair<string, vector<definition>> ("ID_BMS_TEMPERATURES", {
    definition(0, 2, true, "BMS AVERAGE TEMPERATURE", "C", 0.01),
    definition(2, 2, true, "BMS LOW TEMPERATURE", "C", 0.01),
    definition(4, 2, true, "BMS HIGH TEMPERATURE", "C", 0.01)
  });
  CAN_MSG_DEFINITION[0xDA] = pair<string, vector<definition>> ("ID_DETAILED_TEMPERATURES", {
    definition(0, 1, false, "IC ID", "", 0.01),
    definition(1, 2, true, "TEMPERATURE 0", "C", 0.01),
    definition(3, 2, true, "TEMPERATURE 1", "C, 0.01")
  });
  CAN_MSG_DEFINITION[0xDB] = pair<string, vector<definition>> ("ID_BMS_STATUS", {
    ...
    definition(3, 2, true, "BMS CURRENT", "A", 0.01),
  ...
  CAN_MSG_DEFINITION[0xE2] = pair<string, vector<definition>> ("ID_BMS_COULOMB_COUNTS", {
    definition(0, 4, false, "TOTAL CHARGE", "C"),
    definition(4, 4, false, "TOTAL DISCHARGE", "C")
  });
  CAN_MSG_DEFINITION[0xE7] = pair<string, vector<definition>> ("ID_MCU_GPS_READINGS_ALPHA", {
    definition(0, 4, true, "LATITUDE"),
    definition(4, 4, true, "LONGITUDE")
  });
  CAN_MSG_DEFINITION[0xE8] = pair<string, vector<definition>> ("ID_MCU_GPS_READINGS_BETA", {
    definition(0, 4, true, "ALTITUDE"),
    definition(4, 4, true, "SPEED")
  });
  CAN_MSG_DEFINITION[0xE9] = pair<string, vector<definition>> ("ID_MCU_GPS_READINGS_GAMMA", {
    definition(0, 1, false, "FIX QUALITY"),
    definition(1, 1, false, "SATELLITE COUNT"),
    definition(2, 4, true, "TIMESTAMP SECONDS"),
    definition(6, 2, true, "TIMESTAMP MILLISECONDS")
  });
}
