...
public:
    ...
    inline uint16_t get_error_flags() { return error_flags; }
    inline bool get_overvoltage() { return error_flags & 0x1; }
    inline bool get_undervoltage() { return error_flags & 0x2; }
    inline bool get_total_voltage_high() { return error_flags & 0x4; }
    inline bool get_discharge_overcurrent() { return error_flags & 0x8; }
    inline bool get_charge_overcurrent() { return error_flags & 0x10; }
    inline bool get_discharge_overtemp() { return error_flags & 0x20; }
    inline bool get_charge_overtemp() { return error_flags & 0x40; }
    inline bool get_undertemp() { return error_flags & 0x80; }
    inline bool get_onboard_overtemp() { return error_flags & 0x100; }
    inline int16_t get_current() { return current; }
    inline uint8_t get_flags() { return flags; }
    inline bool get_shutdown_g_above_threshold() { return flags & 0x1; }
    inline bool get_shutdown_h_above_threshold() { return flags & 0x2; }
