...
public:
    ...
    inline uint8_t get_ic_id() { return ic_id_group_id & 0xF; }
    inline uint8_t get_group_id() { return ic_id_group_id >> 4; }
    inline uint16_t get_voltage_0() { return voltage_0; }
    inline uint16_t get_voltage_1() { return voltage_1; }
    inline uint16_t get_voltage_2() { return voltage_2; }
