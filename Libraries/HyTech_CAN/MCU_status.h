...
public:
    ...
    inline bool get_bms_ok_high() { return flags & 0x01; }
    inline bool get_imd_okhs_high() { return flags & 0x02; }
    inline bool get_inverter_powered() { return flags & 0x04; }
    inline bool get_shutdown_b_above_threshold() { return flags & 0x08; }
    inline bool get_shutdown_c_above_threshold() { return flags & 0x10; }
    inline bool get_shutdown_d_above_threshold() { return flags & 0x20; }
    inline bool get_shutdown_e_above_threshold() { return flags & 0x40; }
    inline bool get_shutdown_f_above_threshold() { return flags & 0x80; }
    inline int16_t get_temperature() { return temperature; }
    inline uint16_t get_glv_battery_voltage() { return glv_battery_voltage; }
