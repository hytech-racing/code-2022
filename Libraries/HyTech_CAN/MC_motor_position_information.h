...
public:
    ...
    inline int16_t get_motor_angle() { return motor_angle; }
    inline int16_t get_motor_speed() { return motor_speed; }
    inline int16_t get_electrical_output_frequency() { return electrical_output_frequency; }
    inline int16_t get_delta_resolver_filtered() { return delta_resolver_filtered; }
private:
    int16_t motor_angle;
    int16_t motor_speed;
