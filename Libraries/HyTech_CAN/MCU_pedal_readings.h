...
public:
    ...
    inline uint16_t get_accelerator_pedal_raw_1() { return accelerator_pedal_raw_1; }
    inline uint16_t get_accelerator_pedal_raw_2() { return accelerator_pedal_raw_2; }
    inline uint16_t get_brake_pedal_raw() { return brake_pedal_raw; }
    inline uint8_t get_pedal_flags() { return pedal_flags; }

    inline bool get_accelerator_implausibility() { return pedal_flags & 0x01; }
    inline bool get_brake_implausibility() { return pedal_flags & 0x02; }
    inline bool get_brake_pedal_active() { return pedal_flags & 0x04; }
    inline uint8_t get_torque_map_mode() { return torque_map_mode; }
