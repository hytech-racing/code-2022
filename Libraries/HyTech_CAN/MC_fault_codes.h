...
public:
    ...
    uint16_t set_post_fault_lo(uint16_t input) { post_fault_lo = input; }
    uint16_t set_post_fault_hi(uint16_t input) { post_fault_hi = input; }
    uint16_t set_run_fault_lo(uint16_t input) { run_fault_lo = input; }
    uint16_t set_run_fault_hi(uint16_t input) { run_fault_hi = input; }
