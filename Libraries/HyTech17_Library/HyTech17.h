...
#define FCU_STATE_WAITING_TRACTIVE_SYSTEM 2
#define FCU_STATE_TRACTIVE_SYSTEM_NOT_ACTIVE 3
#define FCU_STATE_TRACTIVE_SYSTEM_ACTIVE 4
#define FCU_STATE_ENABLING_INVERTER 5
#define FCU_STATE_WAITING_READY_TO_DRIVE_SOUND 6
#define FCU_STATE_READY_TO_DRIVE 7
...
#define CCU_STATE_NOT_CHARGING 0
#define CCU_STATE_CHARGE_REQUESTED 1
#define CCU_STATE_CHARGING 2
